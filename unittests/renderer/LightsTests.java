...
class LightsTests {
    ...
    /**
     * Produce a picture of a sphere lighted by all the light sources
     */
    @Test
    void sphereAll() {
        scene1.geometries.add(sphere);
        scene1.lights.add(
                new SpotLight(new Color(400, 185, 300), new Point(-25, -50, 10), new Vector(1, 1, -0.5))
                        .setKl(0.0001).setKq(0.00004).setNarrowBeam(10)
        );

        scene1.lights.add(
                new PointLight(new Color(0, 300, 0), new Point(30, 30, 0))
                        .setKl(0.0001).setKq(0.0000002)
        );

        scene1.lights.add(
                new DirectionalLight(new Color(300, 300, 300), new Vector(2, 0, -1))
        );
    ...
    /**
     * Produce a picture of two triangles lighted by all the light sources
     */
    @Test
    void trianglesAll() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(
                new SpotLight(new Color(400, 400, 400), new Point(-40, -70, -100), new Vector(1, 5, -2))
                        .setKl(0.0001).setKq(0.00004).setNarrowBeam(5)
        );
        scene2.lights.add(
                new PointLight(new Color(142, 142, 142), new Point(50, 10, -70))
                        .setKl(0.0001).setKq(0.0002)
        );
        scene2.lights.add(
                new DirectionalLight(new Color(200, 0, 0), new Vector(-5, 5, 5))
        );
        camera2.setResolution(500, 500) //
                .build() //
                .renderImage() //
