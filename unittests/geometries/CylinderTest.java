...
class CylinderTest {
     ...
     */
    void getNormal() {
        Tube tube = new Tube(1, new Ray(Point.ZERO, new Vector(1, 0, 0)), 4);
        ...
        assertEquals(new Vector(-1, 0, 0), tube.getNormal(new Point(0, 0.5, 0.5)),
        ...
        assertEquals(new Vector(1, 0, 0), tube.getNormal(new Point(4, 0.5, 0.5)),
        ...
        assertEquals(new Vector(-1, 0, 0), tube.getNormal(new Point(0, 0, 0)),
        ...
        assertEquals(new Vector(-1, 0, 0), tube.getNormal(new Point(0, 1, 0)),
        ...
        assertEquals(new Vector(1, 0, 0), tube.getNormal(new Point(4, 1, 0)),
